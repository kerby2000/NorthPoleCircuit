...
#ifndef APP_BUILD_PROFILE_NAME
#define APP_BUILD_PROFILE_NAME "bringup"
#endif
...
#ifndef APP_MOTOR_PWM_DEFAULT_HZ
#ifdef APP_MOTOR_PWM_CARRIER_HZ
#define APP_MOTOR_PWM_DEFAULT_HZ APP_MOTOR_PWM_CARRIER_HZ
#else
#define APP_MOTOR_PWM_DEFAULT_HZ 20000u
#endif
#endif

#ifndef APP_MOTOR_WAVE_TABLE_SIZE
#define APP_MOTOR_WAVE_TABLE_SIZE 256u
#endif

#ifndef APP_MOTOR_CONTROL_UPDATE_HZ
#define APP_MOTOR_CONTROL_UPDATE_HZ 4000u
#endif

#ifndef APP_MOTOR_CONTROL_UPDATE_MIN_HZ
#define APP_MOTOR_CONTROL_UPDATE_MIN_HZ 1000u
#endif

#ifndef APP_MOTOR_CONTROL_UPDATE_MAX_HZ
#define APP_MOTOR_CONTROL_UPDATE_MAX_HZ 12000u
#endif
...
#define APP_MOTION_AMPLITUDE_PERMILLE 700u
#endif

#ifndef APP_MOTION_GUARD_DUTY_PERMILLE
#define APP_MOTION_GUARD_DUTY_PERMILLE 600u
#endif
...
#ifndef APP_MOTION_RAMP_MS_START
#define APP_MOTION_RAMP_MS_START 500u
#endif

#ifndef APP_MOTION_RAMP_MS_STOP
#define APP_MOTION_RAMP_MS_STOP 300u
#endif

#ifndef APP_MOTION_RAMP_MS_SPEED
#define APP_MOTION_RAMP_MS_SPEED 500u
#endif

#ifndef APP_DEMO_SCENE_ENABLE
#define APP_DEMO_SCENE_ENABLE 0
#endif

#ifndef APP_DEMO_USB_POWER_ONLY
#define APP_DEMO_USB_POWER_ONLY 1
#endif

#ifndef APP_DEMO_DEFAULT_DURATION_MS
#define APP_DEMO_DEFAULT_DURATION_MS 10000u
#endif

#ifndef APP_DEMO_MAX_RUNTIME_MS
#define APP_DEMO_MAX_RUNTIME_MS 40000u
#endif

#ifndef APP_DEMO_DEFAULT_SPEED_HZ_X1000
#define APP_DEMO_DEFAULT_SPEED_HZ_X1000 8000
#endif

#ifndef APP_DEMO_DEFAULT_INTENSITY_PERCENT
#define APP_DEMO_DEFAULT_INTENSITY_PERCENT 100u
#endif

#ifndef APP_DEMO_DEFAULT_AMPLITUDE_PERMILLE
#define APP_DEMO_DEFAULT_AMPLITUDE_PERMILLE 1000u
#endif

#ifndef APP_DEMO_DEFAULT_GUARD_MODE
#define APP_DEMO_DEFAULT_GUARD_MODE APP_MOTION_GUARD_MODE
#endif

#ifndef APP_DEMO_DEFAULT_GUARD_DUTY_PERMILLE
#define APP_DEMO_DEFAULT_GUARD_DUTY_PERMILLE APP_MOTION_GUARD_DUTY_PERMILLE
#endif

#ifndef APP_DEMO_DEFAULT_AUDIO_TRACK
#define APP_DEMO_DEFAULT_AUDIO_TRACK 1u
#endif

#ifndef APP_DEMO_DEFAULT_AUDIO_VOLUME
#define APP_DEMO_DEFAULT_AUDIO_VOLUME APP_AUDIO_DEFAULT_VOLUME
#endif

#ifndef APP_DEMO_DEFAULT_RGB_BRIGHTNESS
#define APP_DEMO_DEFAULT_RGB_BRIGHTNESS APP_RGB_DEFAULT_BRIGHTNESS
#endif

#ifndef APP_DEMO_DEFAULT_RGB_EFFECT
#define APP_DEMO_DEFAULT_RGB_EFFECT 1
#endif

#ifndef APP_DEMO_DEFAULT_HALL_ENABLE
#define APP_DEMO_DEFAULT_HALL_ENABLE 1
#endif

#ifndef APP_DEMO_RUN_LONG_PRESS_MS
#define APP_DEMO_RUN_LONG_PRESS_MS 1500u
#endif

#ifndef APP_DEMO_TOUCH_DEBOUNCE_MS
#define APP_DEMO_TOUCH_DEBOUNCE_MS 150u
#endif

#ifndef APP_DEMO_HALL_RGB_FLASH_MS
#define APP_DEMO_HALL_RGB_FLASH_MS 120u
#endif

#ifndef APP_MOTION_TOUCH_CONTROL_ENABLE
#if APP_DEMO_SCENE_ENABLE
#define APP_MOTION_TOUCH_CONTROL_ENABLE 0
#else
#define APP_MOTION_TOUCH_CONTROL_ENABLE 1
#endif
#endif
