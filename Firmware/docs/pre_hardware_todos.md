...
| USB CDC | Dev-board Windows enumeration, shell commands, and reset recovery passed on CH592X-EVT-R1-LinkE. Still validate on the target PCB and on Linux before relying on it as the only diagnostic path. |
